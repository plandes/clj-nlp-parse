 ...
 * @author Angel Chang
 */
public class TokenRegexEntityMentionsAnnotator implements Annotator {
  ...
  public TokenRegexEntityMentionsAnnotator(
  ...
  public TokenRegexEntityMentionsAnnotator() {
      this(TokenRegexAnnotations.NERNormalizedAnnotation.class,
	   TokenRegexAnnotations.NERAnnotation.class,
	   TokenRegexAnnotations.MentionsAnnotation.class);
  }

  // note: used in annotate.properties
  @SuppressWarnings("UnusedDeclaration")
  public TokenRegexEntityMentionsAnnotator(String name, Properties props) {
    chunkIdentifier = new LabeledChunkIdentifier();
